        ...
        {({ open }) => (
          <>
              ...
              <div className="flex items-center justify-between py-6">
                <div className="flex justify-start">
                  <a href="#">
                    ...
                    <img className="h-8 h-10 w-auto" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg" alt="" />
                  </a>
                </div>
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <Transition
                          ...
                          <Popover.Panel static className="absolute z-10 -ml-4 mt-3 w-screen max-w-md px-2 px-0">
                            <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                              ...
                              <div className="flex space-y-6 space-y-0 space-x-10 bg-gray-50 p-5 px-8">
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <Transition
                          ...
                          <Popover.Panel
                            static
                            className="absolute left-1/2 z-10 mt-3 w-screen max-w-md -translate-x-1/2 px-2 px-0">
                            <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                              <div className="relative grid gap-6 gap-8 bg-white p-8 px-5 py-6">
                                {resources.map((item) => (
                                  <a key={item.name} href={item.href} className="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                              ...
                              <div className="bg-gray-50 p-5 p-8">
                                <div>
                                  <h3 className="text-sm font-medium uppercase tracking-wide text-gray-500">Recent Posts</h3>
            ...
            <Transition
              ...
              <Popover.Panel focus static className="absolute inset-x-0 top-0 z-10 origin-top-right p-2 transition">
        ...
        <div className="mx-auto w-full max-w-7xl pt-16 pb-20 text-center">
          <div className="px-4 px-8">
            ...
            <div className="mt-10 flex justify-center">
              <div className="mt-3 mt-0 ml-3 rounded-md shadow">
                <a
                  href="#"
